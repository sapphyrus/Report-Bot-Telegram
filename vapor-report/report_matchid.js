...
if (!process.argv[5]) {
    console.log("Usage: node report.js [username] [password] [steamid] [matchid]");
    process.exit();
}
            ...
            switch (header.msg) {
                case ClientWelcome:
                    ...
                    steamGameCoordinator.send({
                        ...
                        matchId: parseInt(process.argv[5]),
                        rptAimbot: 2,
                        rptWallhack: 3,
                        rptSpeedhack: 4,
                        rptTeamharm: 5,
                ...
                case protos.ECsgoGCMsg.k_EMsgGCCStrike15_v2_ClientReportResponse:
                    stop("Report with confirmation ID: " + protos.CMsgGCCStrike15_v2_ClientReportResponse.decode(buffer).confirmationId.toString() + " sent! (MatchID: " + process.argv[5] + ")");
                    break;
                default:
                    break;
            }
